import { E as ExternalTokenizer, L as LRParser, a as LocalTokenGroup, __tla as __tla_0 } from "./index-DMdK_k-l.js";
import { s as styleTags, t as tags$1, L as LanguageSupport, e as LRLanguage, f as indentNodeProp, g as continuedIndent, k as foldNodeProp, l as foldInside, a as syntaxTree, I as IterMode, N as NodeWeakMap, __tla as __tla_1 } from "./CodeContainerApp-BGMyJ1po.js";
...
let css, cssCompletionSource, cssLanguage, defineCSSCompletionSource;
let __tla = Promise.all([
  ...
  const descendantOp = 99, Unit = 1, callee = 100, identifier$1 = 101, VariableName = 2;
  const space = [
    9,
    10,
    11,
  ...
  const identifiers = new ExternalTokenizer((input, stack) => {
    for (let inside = false, dashes = 0, i = 0; ; i++) {
      ...
      if (isAlpha(next) || next == dash || next == underscore || inside && isDigit(next)) {
        ...
        if (inside) input.acceptToken(next == parenL ? callee : dashes == 2 && stack.canShift(VariableName) ? VariableName : identifier$1);
        break;
      }
    }
  });
  ...
  const VariablesByNode = new NodeWeakMap();
  const declSelector = [
    "Declaration"
  ];
  ...
  cssCompletionSource = defineCSSCompletionSource((n) => n.name == "VariableName");
