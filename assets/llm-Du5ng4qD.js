import{j as e,__tla as l}from"./index-CWwRKoNd.js";let i,r=Promise.all([(()=>{try{return l}catch{}})()]).then(async()=>{function s(a){const n={a:"a",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Local LLM (WebLLM)"}),`
...
`,e.jsx("br",{}),`
`,e.jsx("br",{}),`
`,e.jsx("br",{})]})}i=function(a={}){const{wrapper:n}=a.components||{};return n?e.jsx(n,{...a,children:e.jsx(s,{...a})}):s(a)}});export{r as __tla,i as default};
