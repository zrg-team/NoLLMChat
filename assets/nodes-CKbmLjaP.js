import{j as e}from"./index-RiB-44Db.js";function i(n){const s={a:"a",em:"em",h2:"h2",h3:"h3",hr:"hr",img:"img",li:"li",p:"p",strong:"strong",ul:"ul",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.h2,{children:"I. Introduction"}),`
...
`]}),`
`,e.jsx(s.h3,{children:"MCP Node"}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Purpose"}),": Connect to MCP server to listing tools"]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Usage"}),": Under development"]}),`
`]}),`
`,e.jsx(s.hr,{}),`
...
`,e.jsx("br",{}),`
`,e.jsx("br",{}),`
`,e.jsx("br",{})]})}function r(n={}){const{wrapper:s}=n.components||{};return s?e.jsx(s,{...n,children:e.jsx(i,{...n})}):i(n)}export{r as default};
