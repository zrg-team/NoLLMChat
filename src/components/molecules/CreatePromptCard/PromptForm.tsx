...
const PromptForm = memo(({
  ...
  const [promptType, setPromptType] = useState<`${PromptTypeEnum}`>(defaultPromptType || PromptTypeEnum.Chat)
  const [promptRole, setPromptRole] = useState<`${MessageRoleEnum}` | undefined>(defaultPromptRole)
